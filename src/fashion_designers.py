...
def get_fashion_designers_links():
    """
    Function to fetch links to celebrity sub-pages belonging
    to subsection `fashion designers`.
    """

    url = WIKI_BASE_URL + "/wiki/List_of_fashion_designers"
...
def get_fashion_designers_links2():
    """
    Function to fetch links to celebrity sub-pages belonging
    to subsection `fashion designers`.
    """
